/**
 * Login page — modern authentication form with animated UI.
 * Submits credentials to the backend and stores JWT token.
 */
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save token and user data via auth context
    ...
    <div className="w-full min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary text-sm mt-2">Log in to your Pinspire account</p>
        </div>
        ...
        <p className="text-center text-text-secondary text-sm mt-8">
          ...
          <Link to="/register" className="text-pinterest-red hover:text-pinterest-red-hover font-semibold transition-colors">
            Sign up
          </Link>
        </p>
      </motion.div>
